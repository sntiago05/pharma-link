...
| Name | Role |
|------|------|
| **Santiago Andres Rodriguez Manzano** | Lead Developer & Architecture |
| **Joseph David Herreño Theran** | Backend Development & API Design |
| **Mateo Andrés Múnera Opina** | Frontend Development & UI/UX |
| **Daniel Alexander Arciniegas Púa** | Database & Data Layer |
| **Felipe Beltrán** | Integration & Testing |
